...
export class EventInfoComponent implements OnInit {
  ...
  eventsFromServer: Array<any>;

  event1 = {
    urlImg: '/src/resources/img/volga.jpg',
    title: 'VolgaHuck',
  ...
  event2 = {
    urlImg: '/src/resources/img/404.jpg',
    title: '404Fest 2018',
    type: 'Information Technology',
    date: '6-7 сентября 2018',
    organizer: 'Денис Кортунов',
    place: 'Холидей Инн',
    free: 10,
  ...
  event3 = {
    urlImg: '/src/resources/img/panda.jpg',
    title: 'PandaMeetup',
    type: 'Information Technology',
    date: '15 октября 2018',
    organizer: 'IT сообщество',
    place: 'Место проведения уточняется',
    free: 100,
  ...
  constructor(private route: ActivatedRoute,
    ...
    this.eventService.getAll().subscribe(data => {
      ...
      console.log('events from server', this.eventsFromServer);
    });
  }
